...
namespace Host.Quickstart.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            //var returnUrl = result.Properties.Items["redirect_uri"];
            ...
            //var redirectUrl = context.Parameters["redirect_uri"];
        ...
        private (User user, string provider, string providerUserId, IEnumerable<Claim> claims) FindUserFromExternalProvider(AuthenticateResult result)
        {
            ...
            // find external user
            var user = _userManager.FindByIdAsync(providerUserId).Result;
        ...
        {
            var user = _userManager.FindByNameAsync(providerUserId).Result;
            if (user == null)
            {
               ...
               var result = _userManager.CreateAsync( new User
               {
                ...
                user = _userManager.FindByNameAsync(providerUserId).Result;
                //var createUser = _userManager.CreateAsync(userNew).Result;
            //     user = _userManager.FindByIdAsync(providerUserId).Result;
            }
            return user;
        }
